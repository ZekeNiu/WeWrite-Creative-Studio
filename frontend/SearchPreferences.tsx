...
export default function SearchPreferences({cfg,onChange}:{cfg:Settings;onChange:(patch:Partial<SearchConfig>)=>void}){
 ...
 <p className="small-text muted">没有结果时依次尝试已启用渠道。搜索超时、断连、明确限流或服务暂时故障时，仅尝试免费渠道，不重发失败的付费搜索。认证、权限、余额及取消会停止任务。</p>
 <details><summary>高级设置：后备渠道与论文补查</summary>
 ...
 <p className="small-text muted">资料足够、没有新查询或没有实质进展时，补查会结束。</p>
 </details></section>;
}
