...
from tests.quality_fixtures import assessment,judgements,scope_audit,notes as quality_notes
...
def test_existing_upload_checked_before_search_and_single_evidence_model(client,monkeypatch):
    ...
    assert not pending and called==['ResearchPlan','ResearchNotes','EvidenceJudgements','EvidenceScopeAudit','CoverageAudit']
