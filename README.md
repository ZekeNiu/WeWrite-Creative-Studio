...
打开“AI 服务与设置”添加自己的服务地址、API Key 和模型。每个模型可分别测试文本、生图、联网和识图能力。联网接入与文本协议分开配置；在“流程偏好”选择实际使用的联网模型。
...
配图先确定章节位置，再按内容找图或生成。专业图片保留来源与使用依据，封面支持 2.35:1 裁切；实际识图检查为辅助判断，可人工修改和取消采用。
